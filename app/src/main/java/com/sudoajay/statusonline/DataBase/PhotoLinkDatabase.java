...
public class PhotoLinkDatabase extends SQLiteOpenHelper {
    public static final String DATABASE_NAME = "PhotoLinkDatabase.db";
    ...
    public PhotoLinkDatabase(Context context  )
    {
