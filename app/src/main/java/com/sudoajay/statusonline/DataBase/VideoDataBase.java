package com.sudoajay.statusonline.DataBase;
...
public class VideoDataBase extends SQLiteOpenHelper {
    ...
    public static final String col_4 = "ImgLink";
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table " + DATABASE_TABLE_NAME + "(ID INTEGER PRIMARY KEY AUTOINCREMENT , " +
                "Link TEXT , Name TEXT ,ImgLink TEXT )");
    ...
    public void FillIt(final String link, final String name, final String ImgLink){
        SQLiteDatabase sqLiteDatabase = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put(col_2,link);
        contentValues.put(col_3,name);
        contentValues.put(col_4,ImgLink);
